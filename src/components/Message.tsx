...
const Message: React.FC<MessageProps> = ({ text, isUser }) => {
   ...
   return (
      <div>
         <div className={`font-sans rounded-3xl
         ...
         <div className={`flex ${isUser ? 'justify-end' : 'justify-start'}`}>
            <button onClick={copyToClipboard} className='transition-all duration-300 hover:bg-gray-200 hover:rounded-full p-1.5 mt-1 dark:hover:bg-gray-700' title='Copy'>
               {isCopied ?
